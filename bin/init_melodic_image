...
echo "The Melodic Container Setup is minimal because many packages don't support Ubuntu 18.04."
...
sudo apt-get install ros-melodic-desktop-full --assume-yes
...
echo "Installed ROS1 Melodic Environment"
